...
export default function ApiCardAiUi({addToolResult, append, callId}: ApiCardProps) {
        ...
        <form>
          <div className="flex flex-col gap-6">
           ...
           {apiKey ? (
            ...
            <div className="grid gap-2">
              <Button className='cursor-pointer' form="api-form" disabled={loading || !projectID} onClick={handleOnClick}>
