...
export function AnimatedBeamMemoryInput({ className }: { className?: string }) {
    ...
    >
      <div className="flex size-full max-w-xl flex-row items-stretch justify-between gap-10">
        ...
        <div className="flex flex-col justify-center">
          <div
            ref={div6Ref}
            className="bg-secondary p-0.5 rounded-xl z-50 border-2"
          >
...
export function AnimatedBeamDB() {
  ...
  return (
    <div
      className="relative flex w-full max-w-[500px] items-center justify-center overflow-hidden max-p-10"
      ref={containerRef}
    >
