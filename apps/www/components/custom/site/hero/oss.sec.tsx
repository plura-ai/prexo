    ...
    <div className="relative w-full items-center justify-center py-10">
      ...
      <Card >
        <CardContent className="flex flex-col items-start gap-2">
          ...
          <CardDescription>
           It helps us grow and reach more developers like you. Your support
            means a lot to us and encourages us to keep improving the platform.
          </CardDescription>
        </CardContent>
        <CardFooter>
      ...
      <Card >
        <CardContent className="flex flex-col items-start gap-2">
          ...
          <CardDescription>
            ...
            share your experiences, and get help with any issues you encounter.
          </CardDescription>
        </CardContent>
        <CardFooter>
      ...
      <Card >
        <CardContent className="flex flex-col items-start gap-2">
          ...
          <CardDescription>
            ...
            announcements. Stay connected with our community and share your
            thoughts with us.
          </CardDescription>
        </CardContent>
        <CardFooter>
