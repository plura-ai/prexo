...
import { DEFAULT_CHAT_SESSION_ID, DEFAULT_HISTORY_LENGTH } from "../../lib/configs";
...
export class RedisHistory implements MessageHistoryActions {
	public client: Redis;
	...
	constructor(config: RedisHistoryConfig) {
		...
		if (client) {
			...
			throw new Error(
				"Redis Client configuration or client instance is required"
			);
		}
	}
